 ...
 */
final class Version20250715021009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (hostId INT NOT NULL, name VARCHAR(255) NOT NULL, gamemode VARCHAR(255) NOT NULL, is_open TINYINT(1) NOT NULL, is_run TINYINT(1) NOT NULL, time_create DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
